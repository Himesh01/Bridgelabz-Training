...
[Code Link: levelone](https://github.com/Himesh01/Bridgelabz-Training/tree/java-oops-practice/java-oops-practice/gcr-codebase/JavaOopsConcepts/src/com/bridgelabz/oops/levelone)
...
[Code Link: levelone](https://github.com/Himesh01/Bridgelabz-Training/tree/java-oops-practice/java-oops-practice/gcr-codebase/JavaOopsConcepts/src/com/constructorInstance/levelone)
...
Code Link1: [Link - edumentor](https://github.com/Himesh01/Bridgelabz-Training/tree/java-oops-practice/java-oops-practice/Scenario-based-codebase/scenariobasedpractice/src/scenariobasedpractice/edumentor)

Code Link1: [Link - fittrack](https://github.com/Himesh01/Bridgelabz-Training/tree/java-oops-practice/java-oops-practice/Scenario-based-codebase/scenariobasedpractice/src/scenariobasedpractice/fittrack)

Code Link1: [Link - eventease](https://github.com/Himesh01/Bridgelabz-Training/tree/java-oops-practice/java-oops-practice/Scenario-based-codebase/scenariobasedpractice/src/scenariobasedpractice/eventease)
...
[Scenario-based code 1 link](https://github.com/Himesh01/Bridgelabz-Training/tree/java-oops-practice/java-oops-practice/Scenario-based-codebase/scenariobasedpractice/src/scenariobasedpractice/medistore)

[Scenario-based Code 2 link](https://github.com/Himesh01/Bridgelabz-Training/tree/java-oops-practice/java-oops-practice/Scenario-based-codebase/scenariobasedpractice/src/scenariobasedpractice/tourmate)
...
- PayXpress - Java oops scenario based problem
...
- 🔗 **Code Link:**  
👉 [Lambdas, Method Reference & Interfaces](https://github.com/Himesh01/Bridgelabz-Training/tree/java8-programming-practice/java8-programming-practice/gcr-codebase/java8-programming-practice/src/main/java)
...
- Solved practice problems and committed all work.
- 🔗 **Code Link:**  
👉 [Streams & Collectors](https://github.com/Himesh01/Bridgelabz-Training/tree/java8-programming-practice/java8-programming-practice/gcr-codebase/java8-programming-practice/src/main/java/streamApi)

### 🗓 – Scenario based questions on StreamsApi
**(Date: 29-Jan-2026)**

- 🔗 **Code Link:**

👉 [Code link - scenario-based-codebase](https://github.com/Himesh01/Bridgelabz-Training/tree/java8-programming-practice/java8-programming-practice/scenario-based-practice/scenariobasedpractice/src/employeeProblem)
...
- Functional Interface = Interface with only one abstract method Introduced to support Lambda Expressions
...
### 🗓  DBMS Fundamentals, Indexing & SQL Best Practices  
**(Date: 06-Feb-2026)**
...
- 🔗 **Code Link:**  
👉 [DBMS & SQL Practice](https://github.com/Himesh01/Bridgelabz-Training/tree/dbms-jdbc-practice/dbms-jdbc-practice/gcr-codebase/mysqlpractice/src)
